...
//        System.out.println(actual);
        String expected = "TypedObject(className=org.parrot.testobjects.Thing,\n" +
                ...
                " value=[TypedField(fieldName=name,\n" +
                " typedValue=TypedObject(className=java.lang.String,\n" +
                " persistingMethod=VALUE,\n" +
                " value=Shoe)),\n" +
                " TypedField(fieldName=size,\n" +
                " typedValue=TypedObject(className=java.lang.Integer,\n" +
                " persistingMethod=VALUE,\n" +
                " value=12))])";
